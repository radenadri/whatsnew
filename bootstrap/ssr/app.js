...
createInertiaApp({
  ...
  resolve: (name) => resolvePageComponent(`./pages/${name}.vue`, /* @__PURE__ */ Object.assign({ "./pages/Dashboard.vue": () => import("./assets/Dashboard-CPM4lIgF.js"), "./pages/Welcome.vue": () => import("./assets/Welcome-D9LvnZTF.js"), "./pages/auth/ConfirmPassword.vue": () => import("./assets/ConfirmPassword-DMv-fUf3.js"), "./pages/auth/ForgotPassword.vue": () => import("./assets/ForgotPassword-CAWPkaQD.js"), "./pages/auth/Login.vue": () => import("./assets/Login-Dk0R-M9v.js"), "./pages/auth/Register.vue": () => import("./assets/Register-C68XXNR0.js"), "./pages/auth/ResetPassword.vue": () => import("./assets/ResetPassword-DBxl0gOn.js"), "./pages/auth/VerifyEmail.vue": () => import("./assets/VerifyEmail-CVuk3vqz.js"), "./pages/settings/Appearance.vue": () => import("./assets/Appearance-Bb2Lmmw7.js"), "./pages/settings/Password.vue": () => import("./assets/Password-y1EMUPcD.js"), "./pages/settings/Profile.vue": () => import("./assets/Profile-CjbTKRjL.js") })),
